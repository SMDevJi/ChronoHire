  ...
  return (
    <div className='dash max-w-7xl mx-auto p-6'>
      ...
      <div className="prev-interviews grid md:grid-cols-3 gap-3">
        {loading ?
          <div className='wrapper w-full flex justify-center px-4 col-span-3'>
            ...
            <div className="interview border-2 rounded-md p-4" key={idx}>
              ...
              <div className="buttons grid grid-cols-2 gap-3 mt-2">
                ...
                <Dialog open={reattemptOpen} onOpenChange={setReattemptOpenChange}>
                  <form>
                    <DialogTrigger asChild>
                      <button className='cursor-pointer bg-purple-600 rounded font-bold text-white px-3 py-2 w-full'>Start</button>
                    </DialogTrigger>
                    <DialogContent className="sm:max-w-[600px]">
                      <DialogHeader className='mb-4'>
                      ...
                      <div className="grid gap-4">
                        ...
                        <div className="grid gap-1">
                          ...
                          <Input id="role2" name="role2" placeholder='Ex. Full Stack Developer' className='focus-visible:ring-1' value={interview.role} disabled />
                        </div>

                        <div className="grid gap-1">
                          <Label htmlFor="description2" className='text-gray-500'>Job Description/Tech Stack (In Short)</Label>
                          <Input id="description2" name="description2" placeholder='Ex. React, Angular, NodeJS, MySql etc' className='focus-visible:ring-1' value={interview.description} disabled />
                        </div>

                        <div className="grid gap-1">
                          <Label htmlFor="yearsOfExperience2" className='text-gray-500'>Years Of experience</Label>
                          <Input id="yearsOfExperience2" name="yearsOfExperience2" placeholder={interview.yearsOfExperience} value={yearsOfExperience2} type='number' className='focus-visible:ring-1' onChange={(e) => setYOE2(Number(e.target.value))} />
                        </div>

                        <div>
                          <Label htmlFor="difficulty2" className='mb-1 text-gray-500'>Difficulty level</Label>
                          <Select id='difficulty2' name='difficulty2' onValueChange={(value) => setDifficulty2(value)}>
                            <SelectTrigger className="w-full">
                              <SelectValue placeholder="Select" />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div className="grid gap-2">
                          <label htmlFor="update" className="text-sm font-medium">
                            Update Resume?
                          </label><Switch id="update" checked={updateResume}
                            onCheckedChange={setUpdateResume} />
                        </div>

                        {updateResume &&
                          <div className="grid  gap-1 ">
                            <Label htmlFor="resume2" className='text-gray-500'>Upload Your Resume</Label>
                            <Input id="resume2" type="file" onChange={(e) => setResume2(e.target.files[0])} accept=".docx, .pdf" />
                          </div>
                        }
                      ...
                      <DialogFooter>
                        ...
                        <Button type="submit" className={`${creating2 ? 'bg-purple-400 hover:bg-purple-400' : 'bg-purple-600 hover:bg-purple-700'} cursor-pointer`} onClick={() => handleReattempt(interview.id)} >
                          {creating2 ? <FaSpinner className="animate-spin" /> : ''}
